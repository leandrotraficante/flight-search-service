...
export class LoggerService implements NestLoggerService {
  ...
  constructor() {
    ...
    this.logger = winston.createLogger(buildLoggerConfig());
  }
  ...
  childLogger(context: string): LoggerService {
    const child = new LoggerService(); // Creamos una nueva instancia del servicio
  ...
  private formatMessage(message: unknown, context?: string) {
    return {
      ...
      // Incluimos el contexto proporcionado o el contexto fijo del logger
